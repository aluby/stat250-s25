...
If you do 10 tests at the $\alpha = .05$ level, your overall Type I Error rate is 40%

. . . 

If you do 100 tests at the $\alpha = .05$ level, your overall Type I Error rate is 99%!
...
Idea: if we have a desired FDR = $\alpha^*$, what $\alpha$ do we need for each hypothesis test?
