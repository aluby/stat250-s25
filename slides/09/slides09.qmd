...
- The Fisher information "averages out" $\theta$ and summarizes the overall curvature of the log-likelihood function
...
Let $X_1, ..., X_n$ be $n$ Bernoulli($\theta$) trials. Let $\widehat\pi = \frac{\sum X_i}{n}$. How does Var($\widehat\pi$) compare with the CRLB?
